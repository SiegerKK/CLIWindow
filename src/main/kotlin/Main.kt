...
fun main(args: Array<String>) {
    ...
    val tvTest = (TextView(
            ...
            "Пара мыслей про Михаила Ефремова, культуру отмены и уничтожение памятников, которые по какой-то причине недостаточно проговаривают. \n" +
                    ...
                    "\n" +
                    "Благая книга учит: ненавидь грех, но люби грешника. Люди не исчерпываются единственным поступком. Человек - это совокупность всего, что он прожил и совершил. Когда мы раздаём награды и возводим памятники, мы отмечаем их достижения, а не грехи. И как достижения не должны стирать грехи, так же и грехи не должны стирать достижений.\n" +
                    "\n" +
